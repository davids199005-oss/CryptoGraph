...
export function Recommendations() {
  ...
  const { recommendations, loading, apiKeyMissing } = useRecommendations(
    selectedCoinIds,
    selectedCoins,
  );
        ...
        <Card>
          <CardContent sx={{ textAlign: "center", py: 8 }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Please select coins on the Home page to view AI-powered
              recommendations.
            </Typography>
            <Button
              variant="outlined"
      ...
      <Container maxWidth="xl">
        <Box sx={{ mb: 4, textAlign: "center" }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
            Get personalized buy/sell recommendations based on market data
            analysis
          </Typography>
          {apiKeyMissing && (
            <Alert
                    ...
                    <>
                      <Box sx={{ mb: 2 }}>
                        <Chip
                          ...
                          color={
                            rec.recommendation === "buy" ? "success" : "error"
                          }
                          sx={{
                            fontWeight: 700,
                            fontSize: "0.9rem",
